...
/// \brief jsonArray для обработки массива
/// \param arr -  &JsonArray, который заполняется
/// \param str - строка, котрую обрабатываем
/// \param s - позиция первого обрабатываемого символа
/// \return пазицию окончания массива
///
int jsonArray(QJsonArray &arr, QString &str, int s)  {
    /// **Набор переменных:**
...
/// \brief jsonObj для обработки объекта
/// \param obj -  &JsonObject, который заполняется
/// \param str - строка, котрую обрабатываем
/// \param s - позиция первого обрабатываемого символа
/// \return пазицию окончания объекта
///
